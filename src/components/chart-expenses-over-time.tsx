...
interface ExpensesOverTimeDatum {
  date: string;
  amount: number;
}

interface ChartExpensesOverTimeProps {
...
export function ChartExpensesOverTime({ data }: { data: { date: string; amount: number }[] }) {
  ...
  return (
    <Card className="@container/card">
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer
          config={{ expenses: { label: "Expenses", color: "#ef4444" } }}
